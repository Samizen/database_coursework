...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="ADDRESS_ID" DataSourceID="SqlDataSource2" CssClass="grid">
                <Columns>
            ...
            <asp:FormView ID="FormView4" runat="server" DataKeyNames="ADDRESS_ID" DataSourceID="SqlDataSource2" CssClass="form-user">
                <EditItemTemplate>
                    ADDRESS_ID:
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PERSON_ID" DataSourceID="SqlDataSource3" CssClass="grid">
                <Columns>
                    <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
                    ...
                    <asp:BoundField DataField="ADDRESS" HeaderText="ADDRESS_ID" SortExpression="ADDRESS" />
                </Columns>
            </asp:GridView>
            <asp:FormView ID="FormView2" runat="server" DataKeyNames="PERSON_ID" DataSourceID="SqlDataSource3" CssClass="form-user">
                <EditItemTemplate>
                    PERSON_ID:
                ...
                <InsertItemTemplate>
                    ...
                    <br />
                    ADDRESS:
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="ADDRESS" DataValueField="ADDRESS_ID">
                    </asp:DropDownList>
                    <br />
                    <br />
                    <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                ...
                <ItemTemplate>
                    ...
                    <br />
                    ADDRESS_ID:
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="ADDRESS" DataValueField="ADDRESS_ID">
                    </asp:DropDownList>
                    <br />
                    <br />
                    <asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="Insert" />
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="STUDENT_ID" DataSourceID="SqlDataSource1" CssClass="grid">
            <Columns>
                <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
        ...
        <asp:FormView ID="FormView3" runat="server" DataKeyNames="STUDENT_ID" DataSourceID="SqlDataSource1" CssClass="form-user">
            <EditItemTemplate>
                STUDENT_ID:
            ...
            <InsertItemTemplate>
                ...
                PERSON_ID:
                <br />
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="PERSON_NAME" DataValueField="PERSON_ID">
                </asp:DropDownList>
                RUNNING_SEMESTER:
                <asp:DropDownList ID="DropDownList4" runat="server" DataSourceID="SqlDataSource4" DataTextField="SEMESTER" DataValueField="SEMESTER">
                </asp:DropDownList>
                <br />
                <br />
                <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;SEMESTER&quot;, &quot;FEE_TOTAL&quot; FROM &quot;FEE&quot;"></asp:SqlDataSource>
    <h3 class="form-header">Links to Other Forms</h3>
    <div class="navbar">
        <p class="nav-element"><a href="Dashboard.aspx">Home</a></p>
        <p class="nav-element"><a href="Teacher Form.aspx">Teacher Form</a></p>
